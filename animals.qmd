...
# Converter para objeto espacial (sf) e projetar para UTM 22S (Macapá)
# Usamos EPSG:31982 (SIRGAS 2000 / UTM zone 22S) para distâncias em metros
dados_sf <- especies %>%
  st_as_sf(coords = c("lon_x", "lat_y"), crs = 4326) %>%
  st_transform(crs = 31982)

# Definir a matriz de vizinhança
# Para N pequeno (17), KNN (K-Nearest Neighbors) é mais robusto.
# Vamos usar k=3 (cada ponto é comparado aos 3 vizinhos mais próximos)
