...
Você pode estar pensando: "Tanto código e análise para descobrir que não ha uma associação forte entre cães e gatos?". Na ciência aplicada, encontrar um **resultado não significativo** em múltiplas escalas é uma descoberta valiosa por dois motivos principais:
