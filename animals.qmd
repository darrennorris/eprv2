...
O pacote logistf é robusto para resolver problemas de pequenas amostras, mas sua função predict() pode ser um pouco "teimosa" quando alimentada com dados novos. Para contornar isso de forma elegante, usaremos álgebra de matrizes nativa do R dentro do nosso fluxo purrr::map. É um truque avançado, mas o código resultante fica limpo e instrutivo.

Abaixo, apresento o fluxo completo para testar, prever e plotar a interação multiescalar.

O Script use Split-Apply-Combine com Interação e Firth. Neste bloco, vamos criar um "cenário artificial" (expand_grid) e empurrá-lo para dentro dos nossos modelos por meio do pacote purrr.
